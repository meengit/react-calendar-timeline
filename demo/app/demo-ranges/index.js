...
export default class App extends Component {
  constructor (props) {
    ...
    const ranges = [
      {id: 1, start: moment().add(-8, 'hours').valueOf(), end: moment().add(-2, 'hours').valueOf()},
      {id: 2, start: moment().add(2, 'hours').valueOf(), end: moment().add(8, 'hours').valueOf()}
    ]
  ...
  render () {
    const { groups, items, ranges, defaultTimeStart, defaultTimeEnd } = this.state
